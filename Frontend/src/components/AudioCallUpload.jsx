      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-[#0f0f14] border border-amber-500/20 rounded-2xl p-8 mb-12">
          ...
          <p className="text-gray-400 text-sm mt-4 leading-relaxed">
            Each row will be processed through Gemini API to extract call quality metrics, customer information, and agent performance analysis.
          </p>
        </div>
...
export default AudioCallUpload;
